...
def filter_(dic, update_time=0, ask_frequency=1, ratio=0.5, Max=60000):
    rval=[dic[word][0:2] for word in dic if  dic[word][5]>update_time and dic[word][6][0]>1 and dic[word][6][1]*1.0/(dic[word][6][0]+0.01)>ratio]
    return rval[:Max]
...
if __name__=='__main__':
    dic=load(path)
    days=1
    words_to_test=filter_(dic,update_time=time()-days*24*3600)
